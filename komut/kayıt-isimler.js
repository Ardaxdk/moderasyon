...
module.exports.run = async (client, message, args) => {
  ...
  const memberembed = new Discord.MessageEmbed()
    ...
    .setDescription(
      `Lütfen tüm argümanları doğru yerleştiriniz ve tekrar deneyiniz. \`Örnek\`: .isimler @lore`
    );
...
exports.conf = { enabled: true, guildOnly: true, aliases: ["geçmiş","isimler"], permLevel: 0 };

exports.help = { name: "isimler", description: "İsimler Görme.", usage: "isimler @lore" };

...
let reawEmbed = new Discord.MessageEmbed().setAuthor(message.member.displayName, message.author.avatarURL({dynamic: true})).setFooter("Developed By Zara", message.guild.iconURL({dynamic: true})).setColor("RANDOM")

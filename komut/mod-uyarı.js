...
await client.channels.cache.get(kanallar.uyarılog).send(Başarılı.setDescription(`${kullanıcı} - (\`${kullanıcı.id}\`) **Kullanıcısı Uyarıldı**!\n **Uyaran Yetkili**: <@${message.author.id}> - (\`${message.author.id}\`)\n **Uyarılma Sebebi**: \`Belirtilmemiş\`\n **Ceza Bilet Kodu**: \`${uyarıpuan}\``))
...
exports.conf = { enabled: true, guildOnly: false, aliases: ['wawrn'], permLevel: 0, }

exports.help = { name: 'uyarffı' }